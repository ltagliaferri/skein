"""
SKEIN address resolution — LEGACY single-colon `project:folio` scheme.

This is the original addressing scheme. It is still LIVE: client/cli.py and
skein/routes.py use it for cross-project folio addressing, and tests/test_address.py
covers it. It was moved out of skein/address.py (which now hosts the rev 3 `::`
content-hash addressing, an incompatible grammar) so the two can coexist. See
skein:finding-20260529-ahbi for why rev 3 owns skein.address.
