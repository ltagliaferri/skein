...
class _TestFactory:
    ...
    def install_sign_monkeypatch(
        ...
        monkeypatch.setattr(
            "skein_next.signing._build_production_signing_context",
            lambda: fake_ctx,
        )
        monkeypatch.setattr(
            "skein_next.signing._build_identity_token",
    ...
    def install_verify_monkeypatch(self, monkeypatch, **opts) -> None:
        ...
        monkeypatch.setattr(
            "skein_next.signing._build_production_verifier",
