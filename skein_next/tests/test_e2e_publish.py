...
def test_e2e_membership_accepted_no_manifest_rejected(client, instance):  # E5
    ...
    ack2 = ingest(Station(instance.store.data_dir.parent.parent / "i2" / ".skein-next"),
...
def test_read_open_uses_mode_ro_not_immutable_against_wal(tmp_path, monkeypatch):  # E10
    ...
    st = Station(tmp_path / ".skein-next")
    ...
    ro = SkeinNextStore(tmp_path / ".skein-next", read_only=True)
    ro.close()
