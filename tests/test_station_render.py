"""Tests for the agent-facing renderings (skein.render), re-homed at station Stage 4.

Ported verbatim from skein_next/tests/test_render.py — render.py has no internal
imports and moved byte-identical, so these pins carry over unchanged apart from the
skein_next -> skein module retarget.
"""
